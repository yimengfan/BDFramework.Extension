...
namespace FairyGUIDemo
{
    ...
    public class WindowBasics : AFGUIWindowContainer
    {
        ...
        private void PlayPopup()
        {
            ...
            obj.GetChild("n0").onClick.Add((EventContext context) => { _pm.Show((GObject) context.sender, PopupDirection.Down); });
