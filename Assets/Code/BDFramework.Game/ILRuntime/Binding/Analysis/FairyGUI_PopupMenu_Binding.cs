...
{
    unsafe class FairyGUI_PopupMenu_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            args = new Type[]{typeof(FairyGUI.GObject), typeof(FairyGUI.PopupDirection)};
        ...
        static StackObject* AddItem_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            FairyGUI.PopupMenu instance_of_this_method = (FairyGUI.PopupMenu)typeof(FairyGUI.PopupMenu).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)0);
            __intp.Free(ptr_of_this_method);
        ...
        static StackObject* Show_1(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ptr_of_this_method = ILIntepreter.Minus(__esp, 1);
            FairyGUI.PopupDirection @dir = (FairyGUI.PopupDirection)typeof(FairyGUI.PopupDirection).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)20);
            __intp.Free(ptr_of_this_method);
            ...
            instance_of_this_method.Show(@target, @dir);
