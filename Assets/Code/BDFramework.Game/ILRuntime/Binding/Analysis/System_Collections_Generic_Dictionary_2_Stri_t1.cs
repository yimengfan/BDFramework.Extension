...
{
    unsafe class System_Collections_Generic_Dictionary_2_String_GComponent_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(System.Collections.Generic.Dictionary<System.String, FairyGUI.GComponent>);
            args = new Type[]{typeof(System.String), typeof(FairyGUI.GComponent).MakeByRefType()};
            method = type.GetMethod("TryGetValue", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, TryGetValue_0);
            args = new Type[]{typeof(System.String), typeof(FairyGUI.GComponent)};
        ...
        static StackObject* TryGetValue_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            FairyGUI.GComponent @value = (FairyGUI.GComponent)typeof(FairyGUI.GComponent).CheckCLRTypes(__intp.RetriveObject(ptr_of_this_method, __mStack), (CLR.Utils.Extensions.TypeFlags)0);
            ...
            System.Collections.Generic.Dictionary<System.String, FairyGUI.GComponent> instance_of_this_method = (System.Collections.Generic.Dictionary<System.String, FairyGUI.GComponent>)typeof(System.Collections.Generic.Dictionary<System.String, FairyGUI.GComponent>).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)0);
            ...
            switch(ptr_of_this_method->ObjectType)
            {
                ...
                case ObjectTypes.StaticFieldReference:
                 ...
                 case ObjectTypes.ArrayReference:
                    {
                        var instance_of_arrayReference = __mStack[ptr_of_this_method->Value] as FairyGUI.GComponent[];
        ...
        static StackObject* Ctor_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = new System.Collections.Generic.Dictionary<System.String, FairyGUI.GComponent>();
