...
namespace ILRuntime.Runtime.Generated
{
    unsafe class FairyGUI_GTextField_Binding
    {
        ...
        static StackObject* set_color_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            FairyGUI.GTextField instance_of_this_method = (FairyGUI.GTextField)typeof(FairyGUI.GTextField).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)0);
            __intp.Free(ptr_of_this_method);
