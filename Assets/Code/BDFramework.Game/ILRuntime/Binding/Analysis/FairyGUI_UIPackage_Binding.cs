...
namespace ILRuntime.Runtime.Generated
{
    unsafe class FairyGUI_UIPackage_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            args = new Type[]{typeof(System.String), typeof(System.String)};
            method = type.GetMethod("GetItemURL", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, GetItemURL_1);
            args = new Type[]{typeof(System.String), typeof(System.String)};
            method = type.GetMethod("GetItemAsset", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, GetItemAsset_2);
        ...
        static StackObject* GetItemURL_1(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 2);
            ...
            var result_of_this_method = FairyGUI.UIPackage.GetItemURL(@pkgName, @resName);

            return ILIntepreter.PushObject(__ret, __mStack, result_of_this_method);
        }

        static StackObject* GetItemAsset_2(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 2);
