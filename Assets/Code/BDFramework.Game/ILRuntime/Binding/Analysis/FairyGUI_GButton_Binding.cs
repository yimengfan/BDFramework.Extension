...
namespace ILRuntime.Runtime.Generated
{
    unsafe class FairyGUI_GButton_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            app.RegisterCLRMethodRedirection(method, set_title_0);
            args = new Type[]{typeof(System.Boolean)};
            method = type.GetMethod("set_selected", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, set_selected_1);


        }


        static StackObject* set_title_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
        ...
        static StackObject* set_selected_1(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 2);
