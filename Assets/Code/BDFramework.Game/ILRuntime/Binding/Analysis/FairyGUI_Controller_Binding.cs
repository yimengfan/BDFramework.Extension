...
namespace ILRuntime.Runtime.Generated
{
    unsafe class FairyGUI_Controller_Binding
    {
        ...
        static StackObject* set_selectedIndex_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            FairyGUI.Controller instance_of_this_method = (FairyGUI.Controller)typeof(FairyGUI.Controller).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)0);
