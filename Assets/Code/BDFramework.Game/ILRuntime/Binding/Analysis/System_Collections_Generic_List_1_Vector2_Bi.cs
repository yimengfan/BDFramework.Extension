...
namespace ILRuntime.Runtime.Generated
{
    unsafe class System_Collections_Generic_List_1_Vector2_Binding
    {
        ...
        static StackObject* AddRange_2(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ptr_of_this_method = ILIntepreter.Minus(__esp, 1);
            System.Collections.Generic.IEnumerable<UnityEngine.Vector2> @collection = (System.Collections.Generic.IEnumerable<UnityEngine.Vector2>)typeof(System.Collections.Generic.IEnumerable<UnityEngine.Vector2>).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)0);
            __intp.Free(ptr_of_this_method);
