...
namespace ILRuntime.Runtime.Generated
{
    unsafe class FairyGUI_NGraphics_Binding
    {
        ...
        static StackObject* GetMeshFactory_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            FairyGUI.NGraphics instance_of_this_method = (FairyGUI.NGraphics)typeof(FairyGUI.NGraphics).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)0);
        ...
        static StackObject* set_texture_3(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ptr_of_this_method = ILIntepreter.Minus(__esp, 1);
            FairyGUI.NTexture @value = (FairyGUI.NTexture)typeof(FairyGUI.NTexture).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)0);
            __intp.Free(ptr_of_this_method);
